<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./index.php">JG Art & Design Marcenaria 4.0
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="./index.php" target=""><i class="fas fa-home"></i>Principal</a>
                </li>
                <li>
                    <a href="./quemsomos.php"><i class="fas fa-users"></i>Quem somos</a>
                </li>
                <li class="dropdown">
                ...
                <li>
                    <a href="./contato2.php"><i class="fas fa-envelope-square"></i>Contato</a>
                </li>
                <li>
                    <a href="./nossosjobs.php"><i class="glyphicon glyphicon-photo"></i>Nossos trabalhos</a>
                </li>
                <li>
